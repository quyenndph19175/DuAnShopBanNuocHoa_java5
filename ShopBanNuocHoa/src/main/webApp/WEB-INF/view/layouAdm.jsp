        ...
        >
            ...
            <div class="collapse navbar-collapse" id="navbarNavAltMarkup">
                <div class="navbar-nav">
                    ...
                    <a
                            class="navbar-brand"
                            href="/quanLySanPhamTach/getHienThisp"
                            style="
                    color: white;
                    font-weight: 200;
                    margin-left: 70px;
                  ...
                  "
                    ...
                    <a
                            class="navbar-brand"
                            href="/quanLySanPhamChiTiet/getspChiTiet"
                            style="
                    color: white;
                    font-weight: 200;
                    margin-left: 70px;
                    font-size: 18px;
                  "
                    >QUản Lý Sản Phẩm Chi Tiết</a
                    >
                    <a
                            class="navbar-brand"
                            href="/quanLySanPham/getSanPham"
                            style="
                    color: white;
                    font-weight: 200;
                    margin-left: 70px;
                    font-size: 18px;
                  "
                    >QUản Lý Sản Phẩm Chi Tiết 1</a
                    >

                    <a
                            class="navbar-brand"
                            href="/quanLyDonHang/donHang"
                            style="
                    color: white;
                    font-weight: 200;
                    margin-left: 70px;
