...
<div class="container">
    ...
    <div class="text-center"    style=" font-size: 25px;font-weight: 730; position: relative; margin-top: 40px">Giỏ Hàng Của Tôi </div>
    <div class="row">
    ...
    <div class="row">
        <div class="col-8">
            ...
            >
                ...
                <div class="row g-0">
                    <div class="col-md-3">
                        <img src="/img/${spMua.anh}" class="d-block w-100" alt="">
                    </div>
                    <div class="col-md-4">
                        <div class="card-body">
