...
<div class="container">
    ...
    <form action="/quanLySanPham/save2" method="post" enctype="multipart/form-data">

        <div class="mb-3">
            <label for="exampleFormControlInput1" class="form-label"> ID Sản Phẩm : </label>
            <input type="text" class="form-control" style="width: 580px;" name="idsp1" value="${detail.sanPham.id}">
        </div>
        <div class="mb-3">
        ...
        <div class="mb-3">
            ...
            <input type="text" class="form-control" style="width: 580px;" id="exampleFormControlInput1" name="ma"
                   value="${detail.sanPham.ma}">
        </div>
        <div class="mb-3">
            <label for="exampleFormControlInput1" class="form-label"> Tên Sản Phẩm</label>
            <input type="text" class="form-control" style="width: 580px;" id="exampleFormControlInput1" name="ten"
                   value="${detail.sanPham.ten}">
        </div>
    ...
    <table class="table">
        ...
        <c:forEach var="sp" items="${chiTietSanp}" varStatus="hi">
            <tr>
                ...
                <td>${sp.giaBan}</td>
                <td>${sp.moTa}</td>
                <td><a href="/quanLySanPham/remove/${sp.id}/${sp.sanPham.id}">delete</a></td>
                <td><a href="/quanLySanPham/edit/${sp.id}">update</a></td>
